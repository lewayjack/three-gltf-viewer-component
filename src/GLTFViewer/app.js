...
export default class App {
   ...
   */
  constructor(el, location, extraCallBack) {
    ...
    viewer
      ...
      .then((gltf) => {
        if (!this.options.kiosk) {
          this.validationCtrl
            .validate(fileURL, rootPath, fileMap, gltf)
            .then((validationResult) => {
              console.log(validationResult)
              this.extraCallBack &&
                this.extraCallBack.validateCallback &&
                this.extraCallBack.validateCallback(validationResult);
            });
        }
        cleanup();
      });
