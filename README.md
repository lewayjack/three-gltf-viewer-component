# glTF Viewer React Component

forked from [three-gltf-viewer](https://github.com/donmccurdy/three-gltf-viewer),and worked with react.in one word ,remove handlebarsjs part,and bring in reactjs .
